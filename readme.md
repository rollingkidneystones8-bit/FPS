...
index c9d317254cba6a049e63c83a1cbb9184f10b87fc..b0ab985b4e4f5299ad65571e6aa91394c57abb34 100644
--- a/readme.md
+++ b/readme.md
@@ -1,2 +1,65 @@
+# U8 FPS prototype
...
+  - If you want everything from `main` and none of your local changes across many files, repeatedly choose **Accept Incoming** (or use `git checkout --theirs .` to apply it in one shot before adding/committing).
+
+## Running
